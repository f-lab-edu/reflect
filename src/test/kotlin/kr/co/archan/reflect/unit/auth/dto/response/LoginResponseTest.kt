...
class LoginResponseTest {
    ...
    @Test
    @DisplayName("LoginResponse 생성 및 프로퍼티 접근")
    fun `LoginResponse 생성 및 프로퍼티 접근`() {
        // given
    ...
    @Test
    @DisplayName("equals - 같은 값을 가진 LoginResponse는 동등함")
    fun `equals - 같은 값을 가진 LoginResponse는 동등함`() {
        // given
    ...
    @Test
    @DisplayName("equals - 다른 accessToken을 가진 LoginResponse는 동등하지 않음")
    fun `equals - 다른 accessToken을 가진 LoginResponse는 동등하지 않음`() {
        // given
    ...
    @Test
    @DisplayName("equals - 다른 refreshToken을 가진 LoginResponse는 동등하지 않음")
    fun `equals - 다른 refreshToken을 가진 LoginResponse는 동등하지 않음`() {
        // given
    ...
    @Test
    @DisplayName("hashCode - 같은 값을 가진 LoginResponse는 같은 hashCode")
    fun `hashCode - 같은 값을 가진 LoginResponse는 같은 hashCode`() {
        // given
        val response1 = LoginResponse("access-token", "refresh-token")
        val response2 = LoginResponse("access-token", "refresh-token")
    ...
    @Test
    @DisplayName("hashCode - 다른 값을 가진 LoginResponse는 다른 hashCode")
    fun `hashCode - 다른 값을 가진 LoginResponse는 다른 hashCode`() {
        // given
